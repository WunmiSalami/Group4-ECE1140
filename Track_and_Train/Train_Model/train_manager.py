    ...
    def periodic_update(self):
        ...
        try:
            ...
            try:
                ...
                print(f"[periodic_update] Exception updating info_table: {ex}")
                traceback.print_exc()
            ...
            try:
                ...
                print(f"[periodic_update] Exception updating set_speed_label: {ex}")
                traceback.print_exc()
            ...
            except (ValueError, tk.TclError, AttributeError) as ex:
                print(f"[periodic_update] Exception updating speed_entry: {ex}")
                traceback.print_exc()
